                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <label>Trạng thái</label><br>
                                <div style="padding-left:20px;">
                                    <label class="radio"> <input checked="checked" id="rdoTrangThai" name="rdoTrangThai" type="radio" value=""> Tất cả </label>
                                    <label class="radio"><input id="rdoTrangThai" name="rdoTrangThai" type="radio" value="0"> Chưa giảng dạy</label>
                                </div>
                            </div>
                        </td>
                    </tr>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td colspan='4'>
                                    <button name="xuatexcelgiaovu" class="btn btn-info"
                                            onclick="return confirm('Bạn có muốn xuất file Excel không?')"><a
